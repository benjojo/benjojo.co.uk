...
var properties={window:{height:0,width:0},tiles:{count:0,hCount:0,wCount:0}},avatars=[],Flipping=!1,FlipPntr=0;$.getJSON("//daringssl.benjojo.co.uk/DataStore/SteamAvatars/GrabLinks.php?x="+$(window).height()/64+"&y="+$(window).width()/64,function(a){avatars=$.merge(avatars,a.img)});Flipping=!0;$(window).bind("resize load",initTiles);
